...
const Navbar = () => {
  ...
  return (
    <div className='n-container'>
      <div className="n-row">
          <div className="n-col">
            <span className='n-email'>mrahil1139@gmail.com</span>
            {
      ...
      <div className="n-row">
          <nav className="nav">
              <ul className="items">
                  ...
                  <li className="list"><a href="http://localhost:3000" activeClassName="active">About</a></li>
                  <li className="list">< a href="http://localhost:3000" activeClassName="active">Contact</a></li>
              </ul>
